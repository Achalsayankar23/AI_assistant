#!/usr/bin/env python3
"""
Aura AI Voice Authentication Setup
This script helps you set up voice authentication for your Aura AI
"""

import os
import sys
from backend.VoiceAuth import VoiceAuthentication

def main():
    print("🎯 Aura AI Voice Authentication Setup")
    print("=" * 50)
...
if __name__ == "__main__":
    try:
        ...
        print("pip install librosa soundfile scikit-learn pyaudio")
