#!/usr/bin/env python3
"""
Simple Voice Authentication Setup for Aura AI
This uses a more reliable voice authentication system
"""

import os
import sys
from backend.SimpleVoiceAuth import SimpleVoiceAuth

def main():
    print("🎯 Aura AI - Simple Voice Authentication Setup")
    print("=" * 55)
